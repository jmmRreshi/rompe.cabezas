...
var instrucciones = [
"Deberas armar todo el rompecabezas",
"Usando las flechas de tu teclado"
];
...
function agregarUltimoMoviento(direccion){
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  ...
  var grillaNueva = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = grillaNueva;
}
...
function actualizarPosicionVacia(nuevaFila, nuevaColumna) {
   //if (posicionValida(nuevaFila, nuevaColumna)===true) { //<----pruebas
    filaVacia = nuevaFila;
     columnaVacia = nuevaColumna;
    //agregarUltimoMovimiento(filaVacia);
    //agregarUltimoMovimiento(columnaVacia); //<-- mas pruebas de funcionamiento ; 
   }
//intercambiarPosicionesGrilla( filaVacia, columnaVacia, nuevaFila, nuevaColumna );
  //if(grilla <= filaVacia && nuevaColumna <= columnaVacia){
   // return true
  //} ---> pruebas. tambien lo puedo recorrer con un for para ver las posiciones validas dentro de la grilla. 
                    //tambien podemos recorrerlo con un if? no. con el if podes descubrir si la posicion es valida.
                    //for (var i = 0;i<grilla.lentgh; i++);{
                      //if (true) {}
                    //} 
//COMPLETAR
...
function posicionValida(fila, columna) {
 ...
 //if(fila<0 || fila>2 || columna<0 || columna>2) <----- ¿Porque con esta propiedad no inicia el juego?
...
function moverEnDireccion(direccion) {
  ...
  var nuevaColumnaPiezaVacia;     //<----¿que te falta?
  ...
  las funciones posicionValida, intercambiarPosicionesGrilla y actualizarPosicionVacia */
    ...
    if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)) {
        ...
        agregarUltimoMoviento(direccion); //COMPLETAR: Agregar la dirección del movimiento al arreglo de movimientos
    }
}
...
function intercambiarPosiciones(fila1, columna1, fila2, columna2) {
  ...
  var pieza2 = grilla[fila2][columna2];           //<---¿te faltan cosas?
...
//function capturarTeclas(actualizarUltimoMovimiento) {
